                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              functions
                                  .convertImagepath(currentUserData!.image),
                              width: 40.0,
                              height: 40.0,
                              fit: BoxFit.cover,
                            ),
                            ...
                            children: [
                              Padding(
                                ...
                                child: FutureBuilder<ApiCallResponse>(
                                  future: APIAzureGroup.getEnrollmentCall.call(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final listViewGetEnrollmentResponse =
                                        snapshot.data!;

                                    return Builder(
                                      builder: (context) {
                                        final listSubjectEnroll =
                                            APIAzureGroup.getEnrollmentCall
                                                    .listedSubject(
                                                      listViewGetEnrollmentResponse
                                                          .jsonBody,
                                                    )
                                                    ?.toList() ??
                                                [];
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemCount: listSubjectEnroll.length,
                                          itemBuilder: (context,
                                              listSubjectEnrollIndex) {
                                            final listSubjectEnrollItem =
                                                listSubjectEnroll[
                                                    listSubjectEnrollIndex];
                                            return Padding(
