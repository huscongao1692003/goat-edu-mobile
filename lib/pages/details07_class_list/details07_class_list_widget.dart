...
class Details07ClassListWidget extends StatefulWidget {
  const Details07ClassListWidget({
    super.key,
            ...
            children: [
              Expanded(
                child: FutureBuilder<ApiCallResponse>(
                  future: APIAzureGroup.getSubjectByIdCall.call(
                    id: widget.subjectId,
                  ),
                  builder: (context, snapshot) {
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          Hero(
                            tag: functions.convertImagepath(getJsonField(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                functions.convertImagepath(getJsonField(
                                  columnGetSubjectByIdResponse.jsonBody,
                                  r'''$.image''',
                                ).toString()),
