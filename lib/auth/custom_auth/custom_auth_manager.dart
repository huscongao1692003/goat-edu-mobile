...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    ggproAuthUserSubject.add(
      GgproAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<GgproAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  GgproAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GgproAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    ggproAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
