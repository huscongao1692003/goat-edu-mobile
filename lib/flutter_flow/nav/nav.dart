...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(GgproAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Home12ProjectDashboard')
              : const Home12ProjectDashboardWidget(),
        ),
        FFRoute(
          name: 'Home20SearchArticles',
          path: '/home20SearchArticles',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Home20SearchArticles')
              : const Home20SearchArticlesWidget(),
        ),
        FFRoute(
